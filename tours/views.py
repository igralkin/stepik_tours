...
def main_view(request):
    ...
    context_data = {'title': title, 'subtitle': subtitle, 'description': description}
...
def tour_view(request, id):
    tours = {
        1: {
            ...
            "departure": "nsk",
            "picture":
                "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?ixlib=rb-1.2.1&ixid="
        ...
        2: {
            ...
            "departure": "ekb",
            "picture":
                "https://images.unsplash.com/photo-1445019980597-93fa8acb246c?ixlib=rb-1.2.1&ixid="
                "eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60",
            "price": 85000,
            "stars": "5",
            "country": "Вьетнам",
        ...
        12: {
            ...
            "description": "Дом оборудован огромной кухней и одной современной ванной комнатой, а также имеет огромную"
                           ...
                           " в мае этого года и, к сожалению, все еще нуждаются в ремонте. Возможно, понадобится целая"
    ...
    try:
        ...
        raise Http404(f"Тур с номером {id} не найден")
